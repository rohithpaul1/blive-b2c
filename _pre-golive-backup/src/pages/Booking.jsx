...
const Booking = () => {
  ...
  const [verifiedAadhar, setVerifiedAadhar] = useState(true);
  ...
  const [areaList, setAreaList] = useState([
    { id: 1, areaName: "Yelahanka" },
    { id: 2, areaName: "QWERTY" },
    { id: 3, areaName: "ASDF" },
  ]);
  const [stateList, setStateList] = useState([
    { id: 1, stateName: "Karnataka" },
    { id: 2, stateName: "QWERTY" },
    { id: 3, stateName: "ASDF" },
  ]);
  ...
  // get the full hub object
  const selectedHub = hubLocations.find((h) => h.id === selectedHubId);
...
//     });
    ...
    console.log("Environment Variables Check:", {
      VITE_RAZORPAY_KEY_ID: "rzp_live_bwdTunYjyHtxtf", // hardcoded key
      VITE_BACKEND_URL: "https://devevolve-api.blive.co.in/b2c/api", // hardcoded URL
    });
    ...
    try {
      ...
      if (response.status === "success") {
        ...
        const razorpayKey =
          ...
          "rzp_live_bwdTunYjyHtxtf";
        console.log("Razorpay Key Debug:", {
          fromAPI: response.data.razorpayKey,
          //fromEnv: import.meta.env.VITE_RAZORPAY_KEY_ID,
          fromEnv: "rzp_live_bwdTunYjyHtxtf", // hardcoded key
